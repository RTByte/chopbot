...
exports.run = (client, msg, [cmd]) => {
    if (!cmd) {
        const helpMessage = new Discord.RichEmbed()
            ...
            .addField("-voicekick <@user> <...reason>", "Kicks mentioned user from voice channel and logs reason.\nAliases: *'vkick'*, *'vk'*")
            .addField("-ban <@user> <...reason>", "Bans mentioned user and logs reason.\nAliases: *'b'*")
            .addField("-voiceban <@user> <...reason>", "Bans mentioned user from voice channel and logs reason.\nAliases: *'vban'*, *'vb'*")
